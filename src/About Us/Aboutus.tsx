    ...
    return (
        <div>
            <div id="AboutUs" className={styles.AboutUs}>
                ...
                <p>
                    In this two day workshop, participants take part in guided conversations and creative activities. The goal
                    is to explore new ideas and work together across different fields. The shared insights and ideas from the
                    workshop will help create a practical toolkit. This toolkit is designed to support ongoing teamwork and
                    encourage new innovative actions.
                </p>
            </div>

            <div id="Ourpurpose" className={styles.ourPurpose}>
                <h1>Our purpose</h1>
                <p>
                    We make sure you leave inspired, carrying fresh ideas,
                    strengthened by valuable connections, and equipped with practical,
                    actionable tools that empower meaningful collaboration to grow and last
                    well beyond the event.
                </p>
